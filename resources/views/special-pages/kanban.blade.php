                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <button class="btn btn-outline-secondary me-3">
                                Sort by
                                <span class="btn-inner">
                                    <svg class="icon-18" width="18" viewBox="0 0 20 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4"
                                            d="M8.08329 12.958H1.50777C0.675552 12.958 0 13.6217 0 14.4393C0 15.2559 0.675552 15.9207 1.50777 15.9207H8.08329C8.91551 15.9207 9.59106 15.2559 9.59106 14.4393C9.59106 13.6217 8.91551 12.958 8.08329 12.958Z"
                                            fill="currentColor" />
                                        <path opacity="0.4"
                                            d="M20.0001 3.37867C20.0001 2.56214 19.3246 1.89844 18.4934 1.89844H11.9179C11.0857 1.89844 10.4102 2.56214 10.4102 3.37867C10.4102 4.1963 11.0857 4.86 11.9179 4.86H18.4934C19.3246 4.86 20.0001 4.1963 20.0001 3.37867Z"
                                            fill="currentColor" />
                                        <path
                                            d="M6.87774 3.37856C6.87774 5.24523 5.33886 6.75821 3.43887 6.75821C1.53999 6.75821 0 5.24523 0 3.37856C0 1.51298 1.53999 0 3.43887 0C5.33886 0 6.87774 1.51298 6.87774 3.37856Z"
                                            fill="currentColor" />
                                        <path
                                            d="M19.9998 14.3992C19.9998 16.2648 18.4609 17.7777 16.5609 17.7777C14.6621 17.7777 13.1221 16.2648 13.1221 14.3992C13.1221 12.5325 14.6621 11.0195 16.5609 11.0195C18.4609 11.0195 19.9998 12.5325 19.9998 14.3992Z"
                                            fill="currentColor" />
                                    </svg>
                                </span>
                            </button>
                            <button class="btn btn-outline-secondary me-3">
                                Group by
                                <span class="btn-inner">
                                    <svg class="icon-18" width="18" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4"
                    ...
                    <div class="row">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <span class="d-flex align-items-center h5 mb-0" id="dropdownMenuButton07"
                                                ...
                                                <svg width="22" viewBox="0 0 22 5" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="group1-wrap">
                            <div class="group" id="group1">
                                <x-widgets.kanban-card id="001" kanbanTopic="Design" kanbanColor="warning"
                                    kanbanTitle="Create Sidebar in Dashboard" kanbanText="13 Feb 2022">
                                </x-widgets.kanban-card>
                                <x-widgets.kanban-card id="002" kanbanTopic="Research" kanbanColor="info"
                                    kanbanTitle="General improvement in pages" kanbanText="23 Feb 2022">
                                </x-widgets.kanban-card>
                                <x-widgets.kanban-card id="003" kanbanTopic="Planning" kanbanColor="primary"
                                    kanbanTitle="Product List view Changes" kanbanText="28 Feb 2022">
                                </x-widgets.kanban-card>
                                <x-widgets.kanban-card id="004" kanbanTopic="Design" kanbanColor="warning"
                                    kanbanTitle="Add Multiple theme options" kanbanText="01 Mar 2022">
                                </x-widgets.kanban-card>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="card bg-transparent shadow-none">
                                <div class="iq-dashed-border rounded">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="badge bg-soft-primary"><svg class="icon-20"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class=" mb-0">In Progress <span class="text-warning">06</span></h6>
                                        <div class="dropdown">
                        ...
                        <div class="group2-wrap">
                            <div class="group" id="group2">
                                <x-widgets.kanban-card id="011" kanbanTopic="Research" kanbanColor="info"
                                    kanbanTitle="Notification Module Setting" kanbanText="15 Feb 2022">
                                </x-widgets.kanban-card>
                                <x-widgets.kanban-card id="012" kanbanTopic="Planning" kanbanColor="primary"
                                    kanbanTitle="Admin Panel Customization" kanbanText="20 Feb 2022">
                                </x-widgets.kanban-card>
                            </div>
                        </div>
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class="mb-0">Reviews 01</h6>
                                        <div class="dropdown">
                                            <span class="d-flex align-items-center h5 mb-0" id="dropdownMenuButton09"
                                                role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="22" viewBox="0 0 22 5" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="dropdownMenuButton09" style="">
                                                <a class="dropdown-item" href="#">
                                                    <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path opacity="0.4"
                        ...
                        <div class="group3-wrap">
                            <div class="group" id="group3">
                                <x-widgets.kanban-card id="021" kanbanTopic="Planning" kanbanColor="primary"
                                    kanbanTitle="Sidebar in Dashboard Themes" kanbanText="17 Feb 2022">
                                </x-widgets.kanban-card>
                            </div>
                        </div>
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class=" mb-0">Closed<span class="text-success"> 03</span></h6>
                                        <div class="dropdown">
                                            <span class="d-flex align-items-center h5 mb-0" id="dropdownMenuButton10"
                                                role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="22" viewBox="0 0 22 5" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="dropdownMenuButton10" style="">
                                                <a class="dropdown-item" href="#">
                                                    <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path opacity="0.4"
                        ...
                        <div class="group4-wrap">
                            <div class="group" id="group4">
                                <x-widgets.kanban-card id="031" kanbanTopic="Content" kanbanColor="success"
                                    kanbanTitle="Login screen update in mobile app" kanbanText="10 Feb 2022">
                                </x-widgets.kanban-card>
                                <x-widgets.kanban-card id="032" kanbanTopic="Design" kanbanColor="warning"
                                    kanbanTitle="Helpdesk in Dashboard Themes" kanbanText="18 Feb 2022">
                                </x-widgets.kanban-card>
                            </div>
                        </div>
                        <div class="col-lg-12">
