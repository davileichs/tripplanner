            ...
            <div class="card   rounded">
               <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between mb-5">
                    <div>
                        <p class="text-center">
                            <svg class="text-primary icon-40 text-center" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25333 2H22.0444L29.7244 15.2103L22.0444 28.1333H7.25333L0 15.2103L7.25333 2ZM11.2356 9.32316H18.0622L21.3334 15.2103L18.0622 20.9539H11.2356L8.10669 15.2103L11.2356 9.32316Z" fill="#7016d0"/>
                     ...
                     <div class="text-end">
                        <p class="">Legal Registration No. 12231</p>
                        <p class="">Email: support@qompacui.com</p>
                        <p>Web: www.Qompacui.com</p>
                        <p class="mb-0">Phone: (208) 555-0112</p>
                     </div>
                  </div>
                  <div class="d-flex align-items-center justify-content-between">
                     <div>
                        ...
                        <div>
                           <span class="mt-2">Due Date: 29 Mar 2021</span><span class="ms-2">Due Date: 29 Mar 2021</span>
                        </div>
                     </div>
                     <div>
                        <svg width="130" height="130" viewBox="0 0 130 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <g clip-path="url(#clip0_4_6485)">
                  ...
                  <div class="row mt-4">
                     <div class="col-lg-3">
                        <div class="d-flex ">
                           ...
                           <div class="ms-2">
                              <h4>Qompac UI ltd.</h4>
                              <p class="">4517 Washington Ave. Manchester, Kentucky 39495</p>
                     ...
                     <div class="col-lg-3">
                        <div class="d-flex ">
                           ...
                           <div class="ms-2">
                              <h4>Elon Musk</h4>
                              <p class="">2972 Westheimer Rd. Santa Ana, Illinois 85486 </p>
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td></td>
                                    <td>
                                       <h6 class="mb-0 text-center">Total:</h6>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-center"></td>
                                    <td>
                                       <h6 class="mb-0 text-center">Tax:</h6>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-center"></td>
                                    <td>
                                       <h6 class="mb-0 text-center">Discount:</h6>
                                    </td>
