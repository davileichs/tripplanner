            ...
            <div class="card-body">
                <div class="icon-grid">
                    ...
                    <div class="icon-box">
                        ...
                        <div id="bold-svg-container-102">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" viewBox="0 0 24 24" fill="none">
                                ...
                                <path opacity="0.89" d="M13.5 12C14.3284 12 15 11.3284 15 10.5C15 9.67157 14.3284 9 13.5 9C12.6716 9 12 9.67157 12 10.5C12 11.3284 12.6716 12 13.5 12Z" fill="white" fill-opacity="0.6"/>
                                </g>
                            </svg>
                    ...
                    <div class="icon-box">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" viewBox="0 0 24 24" fill="none">
                            <path d="M4 3C4 1.89543 4.89543 1 6 1H13.0801C13.664 1 14.2187 1.25513 14.5986 1.69841L19.5185 7.43822C19.8292 7.80071 20 8.26239 20 8.73981V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3Z" fill="currentColor"/>
                    ...
                    <div class="icon-box">
                        ...
                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M19.9876 12.7139C19.9026 12.7198 19.8173 12.7029 19.7402 12.6639L14.7222 10.0921C14.5844 10.0211 14.494 9.88782 14.4836 9.73793C14.4733 9.58804 14.5444 9.44359 14.6711 9.35425L19.2866 6.11519C19.421 6.02124 19.5979 6.00373 19.7483 6.07095C19.8992 6.13755 19.9992 6.27715 20.0102 6.43576L20.4126 12.2466C20.4236 12.4053 20.3439 12.5573 20.2035 12.6441C20.1375 12.6854 20.0629 12.7087 19.9876 12.7139" fill="currentColor"/>
                        </svg>
                        </div>
                    </div>
                    <div class="icon-box">
                        <div class="overlay">
                            <button class="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#bold-svg-container-112" title="Copy">Copy</button>
                        </div>
                        <div id="bold-svg-container-112">
                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.2305 3.16888L12.2305 19.1689" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M8.5 7.52315C8.5 7.43414 8.52543 7.3464 8.57499 7.26884L11.8359 2.22316C11.9259 2.08456 12.0818 2 12.25 2C12.4182 2 12.5741 2.08456 12.664 2.22316L15.925 7.26884C16.0195 7.4157 16.0254 7.60136 15.9387 7.75331C15.8526 7.9059 15.6889 8 15.5109 8L8.98904 8C8.81103 8 8.64736 7.9059 8.56129 7.75331C8.52021 7.68147 8.5 7.60199 8.5 7.52315" fill="currentColor"/>
                            <path d="M8.5 15.4768C8.5 15.5659 8.52543 15.6536 8.57499 15.7312L11.8359 20.7768C11.9259 20.9154 12.0818 21 12.25 21C12.4182 21 12.5741 20.9154 12.664 20.7768L15.925 15.7312C16.0195 15.5843 16.0254 15.3986 15.9387 15.2467C15.8526 15.0941 15.6889 15 15.5109 15H8.98904C8.81103 15 8.64736 15.0941 8.56129 15.2467C8.52021 15.3185 8.5 15.398 8.5 15.4768" fill="currentColor"/>
                        </svg>
                         </div>
                    </div>
                    <div class="icon-box">
                        <div class="overlay">
                            <button class="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#bold-svg-container-113" title="Copy">Copy</button>
                        </div>
                        <div id="bold-svg-container-113">
                            <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.8311 12.2305L3.83112 12.2305" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15.4768 8.5C15.5659 8.5 15.6536 8.52543 15.7312 8.57499L20.7768 11.8359C20.9154 11.9259 21 12.0818 21 12.25C21 12.4182 20.9154 12.5741 20.7768 12.664L15.7312 15.925C15.5843 16.0195 15.3986 16.0254 15.2467 15.9387C15.0941 15.8526 15 15.6889 15 15.5109V8.98904C15 8.81103 15.0941 8.64736 15.2467 8.56129C15.3185 8.52021 15.398 8.5 15.4768 8.5" fill="currentColor"/>
                                <path d="M7.52315 8.5C7.43414 8.5 7.3464 8.52543 7.26884 8.57499L2.22316 11.8359C2.08456 11.9259 2 12.0818 2 12.25C2 12.4182 2.08456 12.5741 2.22316 12.664L7.26884 15.925C7.4157 16.0195 7.60136 16.0254 7.75331 15.9387C7.9059 15.8526 8 15.6889 8 15.5109V8.98904C8 8.81103 7.9059 8.64736 7.75331 8.56129C7.68147 8.52021 7.60199 8.5 7.52315 8.5" fill="currentColor"/>
                            </svg>
                        </div>
                    </div>
                </div>
