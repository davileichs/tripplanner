        ...
        <div class="d-flex justify-content-between w-100 align-items-center">
            ...
            <div class="col-auto navbar-brand">
                <a href="{{ route('dashboards') }}" class="d-flex">
                    <x-logo />
                    <h4 class="logo-title d-none d-sm-block text-white" data-setting="app_name">{{ env('APP_NAME') }}
                    </h4>
                </a>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="iq-nav-menu list-unstyled">
                        ...
                        <li class="nav-item"><a class="nav-link {{ activeRoute(route('menu-style.dual-compact')) }}"
                                href="{{ route('menu-style.dual-compact') }}"><span class="item-name">Dual
                                    Compact</span></a></li>
    ...
    <div class="container-fluid">
        <nav class="nav nav-underline" aria-label="Secondary navigation">
            <ul class="iq-nav-menu list-unstyled flex-row">
                <li class="nav-item active"><a class="nav-link {{ activeRoute(route('menu-style.dual-compact')) }}"
                        href="{{ route('menu-style.dual-compact') }}">Dashboard</a></li>
                <li class="nav-item"><a class="nav-link {{ activeRoute(route('analytics-dashboard')) }}"
                        href="{{ route('analytics-dashboard') }}">Analytics</a></li>
                <li class="nav-item"><a class="nav-link {{ activeRoute(route('crypto-dashboard')) }}"
                        href="{{ route('crypto-dashboard') }}">Crypto</a></li>
            </ul>
        </nav>
    </div>
