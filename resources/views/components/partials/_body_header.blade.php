...
<nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        ...
        <div class="d-flex align-items-center justify-content-between product-offcanvas">
            <div class="breadcrumb-title  me-3 pe-3 d-none d-xl-block border-end">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                id="animatedAuth">
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.signin') }}">Sign In</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.signup') }}">Sign Up</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.email') }}">Email</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.lock-screen') }}">Lock screen</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.reset-password') }}">Reset
                                                        password</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.two-factor') }}">Two factor</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('animated.account-deactivate') }}">Account
                                                        deactivate</a></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                id="simpleAuth">
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('simple.signin') }}">Sign In</a></li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ route('simple.signup') }}">Sign Up</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 header-show">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="mode-drop">
                        <li>
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="navbarDropdown"
