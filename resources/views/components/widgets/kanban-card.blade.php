@props(['kanbanColor', 'kanbanTopic', 'id', 'kanbanTitle', 'kanbanText'])
<div class="col-lg-12 group__item">
    <div class="card">
        <div class="card-body">
            <div class="d-grid grid-flow-col align-items-center justify-content-between mb-2">
                <div class="d-flex align-items-center">
                    <span class="badge  bg-soft-{{ $kanbanColor }} mb-3">{{ $kanbanTopic }}</span>
                </div>
                <div class="dropdown">
                    <span class="h5" id="dropDown-{{ $id }}" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropDown-{{ $id }}"
                        style="">
            ...
            <h6 class="mb-2">{{ $kanbanTitle }}</h6>
            <small class="">{{ $kanbanText }}</small>
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="iq-media-group-1">
                    <a href="#" class="iq-media-1 rounded">
                        <img src="{{ asset('images/avatars/06.png') }}" class="img-fluid icon iq-icon-box-2 rounded"
                            alt="{{ $id }}">
                    </a>
                    <a href="#" class="iq-media-1 rounded">
                        <img src="{{ asset('images/avatars/07.png') }}" class="img-fluid icon iq-icon-box-2 rounded"
                            alt="{{ $id }}">
                    </a>
                    <a href="#" class="iq-media-1 rounded">
                        <img src="{{ asset('images/avatars/08.png') }}" class="img-fluid icon iq-icon-box-2 rounded"
                            alt="{{ $id }}">
                    </a>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="btn btn-icon btn-soft-primary btn-sm">
                        <span class="btn-inner">
                            <svg class="icon-16" width="10" viewBox="0 0 13 8" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M12.5 1.5522C12.5 1.82039 12.3962 2.08998 12.1887 2.29498L7.25669 7.1911C7.05628 7.38908 6.7848 7.5 6.50053 7.5C6.21769 7.5 5.94621 7.38908 5.7458 7.1911L0.810919 2.29498C0.395888 1.88357 0.395888 1.21803 0.813761 0.806624C1.23163 0.396625 1.90677 0.398029 2.3218 0.809432L6.50053 4.95576L10.6793 0.809432C11.0943 0.398029 11.768 0.396625 12.1859 0.806624C12.3962 1.01162 12.5 1.28262 12.5 1.5522Z"
                                    fill="currentColor" />
                            </svg>
