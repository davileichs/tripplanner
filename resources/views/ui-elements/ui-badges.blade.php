<x-app-layout :assets="$assets ?? []" title='ui-badges' :isBanner="true">
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <p class="mb-2">Using the contextual <code>.badge-*</code> classes on an <code></code> element quickly provide <em>actionable</em> badges with hover and focus states.</p>
