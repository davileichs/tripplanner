                            ...
                            <div class="col-md-9">
                                ...
                                <div class="docs-demo">
                                    <div class="img-container">
                                        <img src="{{ asset('images/plugins/01.jpg') }}" alt="Picture" class="img-fluid"
                                            id="main-img">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row" id="actions">
                                    <div class="col-md-9 docs-buttons my-2">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path d="M12.2305 3.16998L12.2305 20.17" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M8.70001 5.51477L12.1997 1.99996L15.7 5.51477"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M8.70001 16.9999L12.1997 20.5099L15.7 16.9999"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M20.2086 11.1468L3.20862 11.1468" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M6.78967 7.70001L3.27967 11.1997L6.78967 14.7"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M17 7.70001L20.51 11.1997L17 14.7" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <circle cx="11.7666" cy="11.7666" r="8.98856"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M18.0183 18.4852L21.5423 22" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M11.4999 7V16" stroke="#fff" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M16 11.5001H7" stroke="#fff" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                            </button>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btn-sm" data-method="move"
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-method="move"
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg class="icon-16" width="16" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.2744 19.75V4.75" stroke="currentColor"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M4.19904 5.65222L4.88056 10.1704L9.39651 9.46938"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M19.801 5.65222L19.1194 10.1704L14.6035 9.46938"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M19.8311 12.2305L3.83112 12.2305" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M15.9167 7.46121L20.7063 12.2302L15.9167 17"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M7.78958 7.46121L3 12.2302L7.78958 17" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.2305 3.16888L12.2305 19.1689" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M7.46121 7.08325L12.2302 2.29367L17 7.08325"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M7.46121 15.2104L12.2302 20L17 15.2104"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btn-sm" data-method="crop"
                                                title="Crop">
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    title="cropper.crop()">
                                                    <svg class="icon-16" width="16" viewBox="0 0 24 24"
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-method="clear"
                                                title="Clear">
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    title="cropper.clear()">
                                                    <svg class="icon-16" width="16" viewBox="0 0 24 24"
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg class="icon-16" width="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            stroke="currentColor" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <path d="M12.1128 13.9526V16.1746" stroke="currentColor"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                    </svg>
                                                </span>
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            fill="#fff" />
                                                        <path d="M16.1692 15.4857L20.8122 13.981L22.2973 18.6312"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path
                                                            ...
                                                            fill="#fff" />
                                                        <path d="M8.82965 8.74048L4.12772 10.0496L2.8385 5.34131"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                                ...
                                                <span class="docs-tooltip" data-toggle="tooltip"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M12.0214 2.19051V14.2315" stroke="#fff"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M9.10626 5.11884L12.0213 2.19084L14.9373 5.11884"
                                                            stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                        ...
                                        <div class="modal fade docs-cropped" id="getCroppedCanvasModal"
                                            role="dialog" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle"
                                            tabindex="-1">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm my-2"
                                            data-method="scale" data-option="-2" data-second-option="-1">
                                            <span class="docs-tooltip" data-toggle="tooltip"
                                    ...
                                    <div class="col-md-3 docs-toggles">
                                        ...
                                        <div class="dropdown dropup docs-options pt-2">
                                            <button class="btn btn-primary btn-sm btn-block dropdown-toggle"
                                                type="button" id="toggleOptions" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                Toggle Options
                                            ...
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="toggleOptions">
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="responsive"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="restore"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="modal"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="guides"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="center"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="highlight"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="background"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="autoCrop"
                                                            type="checkbox" name="autoCrop" checked>
                                                        <label class="form-check-label"
                                                            for="autoCrop">autoCrop</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="movable"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="rotatable"
                                                            type="checkbox" name="rotatable" checked>
                                                        <label class="form-check-label"
                                                            for="rotatable">rotatable</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="scalable"
                                                            type="checkbox" name="scalable" checked>
                                                        <label class="form-check-label"
                                                            for="scalable">scalable</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="zoomable"
                                                            type="checkbox" name="zoomable" checked>
                                                        <label class="form-check-label"
                                                            for="zoomable">zoomable</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="zoomOnTouch"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="zoomOnWheel"
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <div class="croppy-round">
                                    <img src="{{ asset('images/plugins/01.jpg') }}" alt="picture"
                                        class="img-fluid" id="round-crop">
                                </div>
