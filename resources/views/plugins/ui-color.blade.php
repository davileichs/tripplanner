        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Qompac UI Color</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <p>Similar to the contextual text color classes, easily set the background of an element to any
                            ...
                            Background utilities <strong>do not set <code>color</code></strong>, so in some cases you’ll
                            want to use <code>.text-*</code> utilities.</p>
                        <div class="row mt-4">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Qompac UI Text Color</h4>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <p>Contextual text classes also work well on anchors with the provided hover and focus states.
                            <strong>Note that the <code>.text-white</code> and <code>.text-muted</code> class has no
                                additional link styling beyond underline.</strong></p>
                        <p><a href="#"
                                class="bg-soft-primary ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">primary link</a></p>
                        <p><a href="#"
                                class="bg-soft-secondary ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Secondary link</a>
                        </p>
                        <p><a href="#"
                                class="bg-soft-success ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Success link</a></p>
                        <p><a href="#" class="bg-soft-danger ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Danger
                                link</a></p>
                        <p><a href="#"
                                class="bg-soft-warning ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Warning link</a></p>
                        <p><a href="#" class="bg-soft-info ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">bg-Info
                                link</a></p>
                        <p class="mb-0"><a href="#"
                                class="dark ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark link</a></p>
                    </div>
                </div>
            </div>
        </div>
