...
(function () {
  ...
  this.IQUtils.getVariableColor = function () {
    ...
    var color2 = getComputedStyle(document.body).getPropertyValue("--".concat(prefix, "secondary"));
    ...
    var color5 = getComputedStyle(document.body).getPropertyValue("--".concat(prefix, "tertiray"));
    return {
      primary: color1.trim(),
